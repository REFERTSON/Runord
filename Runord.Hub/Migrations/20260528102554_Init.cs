        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CpuTotal = table.Column<double>(type: "double precision", nullable: false),
                    RamTotalGb = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    RamUsageGb = table.Column<double>(type: "double precision", nullable: false),
                    StorageUsageGb = table.Column<double>(type: "double precision", nullable: false),
                    NetworkInMbps = table.Column<double>(type: "double precision", nullable: false),
                    NetworkOutMbps = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplacedByTokenId = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    LastModified = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Md5Hash = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    IsResult = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    LastModified = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
